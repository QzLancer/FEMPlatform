...
Point(6) = {40/2, CS_DONGTIEXIN+38.17-GAP-20.98+2.46-disp, 0, lc};
...
Point(48) = {40/2, CS_DONGTIEXIN+38.17-GAP-1.91-disp, 0, maxsize};
Point(49) = {0, 0, 0, maxsize};
//Point(50) = {41.9/2, CS_DONGTIEXIN+38.17-GAP-1.91-disp-6.8, 0, lc};
Point(50) = {40/2, CS_DONGTIEXIN+38.17-GAP-1.91-disp-6.8, 0, lc};
...
Field[10] = Min;
Field[10].FieldsList = {2,4,5,6,7,8};
